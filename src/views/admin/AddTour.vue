<template>
  ...
  <div class="add-container">
    ...
    <div class="category-type-from">
      <div class="mb-3 w-25">
        ...
        <select
          ...
          aria-label="Smal select example"
          v-model="tourCategory"
        >
    ...
    <label for="" class="form-label"
      >Thời gian: {{ tourLength }}N{{ tourLength - 1 }}Đ</label
    >
    <div style="display: flex; flex-direction: row; align-items: center">
      ...
      <div style="display: flex; flex-direction: row; align-items: center">
        ...
        <i
          ...
          class="fa-solid fa-fire fa-bounce"
        ></i>
      </div>
    </div>
    <div class="mb-3 w-50">
    ...
    >
      <label for="customRange2" class="form-label" style="width: 10rem"
        >Mức độ đề xuất:</label
      >
      <p
        style="width: 2rem; margin-right: 1rem; color: red; font-weight: bold"
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button
            ...
            data-bs-target="#accordion-special"
            aria-expanded="true"
            aria-controls="accordion-special"
          >
            Điểm khác biệt
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button
            ...
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#accordion-bonus"
            aria-expanded="false"
            aria-controls="accordion-bonus"
          >
            Dịch vụ đi kèm
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button
            ...
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#accordion-visa"
            aria-expanded="false"
            aria-controls="accordion-visa"
          >
            Visa
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button
            ...
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#accordion-detail"
            aria-expanded="false"
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button
            ...
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#accordion-price-service"
            aria-expanded="false"
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button
            ...
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#accordion-guide"
            aria-expanded="false"
            aria-controls="accordion-guide"
          >
            Lưu ý và hướng dẫn
          </button>
        </h2>
